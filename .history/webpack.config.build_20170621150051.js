...
module.exports = {
    ...
    module: {
        loaders: [{
            ...
            test: /\.less$/,
            exclude: /^node_modules$/,
            loader: ExtractTextPlugin.extract('style', ['css?modules&localIdentName=[path][name]---[local]---[hash:base64:5]', 'autoprefixer', 'less'])
        }, {
            test: /\.scss$/,
            exclude: /^node_modules$/,
            loader: ExtractTextPlugin.extract('style', ['css?modules&localIdentName=[path][name]---[local]---[hash:base64:5]', 'autoprefixer', 'sass'])
        }, {
